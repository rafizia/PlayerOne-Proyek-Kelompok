...
@export var base_speed: float = 120.0  # Kecepatan tinggi (unit cepat)
@export var health: float = 80.0       # Health rendah
@export var max_health: float = 80.0
@export var gold_reward: int = 15      # Reward gold saat dibunuh
