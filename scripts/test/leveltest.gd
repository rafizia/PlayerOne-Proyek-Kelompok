...
var wave_data = [
	[ {"scene": preload("res://scenes/enemy/tank1.tscn") }, {"scene": preload("res://scenes/enemy/flyer.tscn") }, 
	{"scene": preload("res://scenes/enemy/flyer.tscn") } , {"scene": preload("res://scenes/enemy/flyer.tscn") } , 
	{"scene": preload("res://scenes/enemy/flyer.tscn") } , 
	{"scene": preload("res://scenes/enemy/flyer.tscn") } , 
	{"scene": preload("res://scenes/enemy/tank1.tscn") } , 
	{"scene": preload("res://scenes/enemy/flyer.tscn") } , 
	{"scene": preload("res://scenes/enemy/flyer.tscn") } , 
	{"scene": preload("res://scenes/enemy/flyer.tscn") }  ],
